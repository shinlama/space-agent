...
from modules.config import FACTOR_DEFINITIONS, FACTOR_NAMES
...
8. 반드시 아래 {len(VLM_FACTOR_ORDER)}개 요인을 모두 반환하세요:
   {", ".join(VLM_FACTOR_ORDER)}
